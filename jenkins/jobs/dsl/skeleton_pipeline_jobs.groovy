...
import mdop.cartridge.properties.*;
...
buildAppJob.with{
  ...
  scm scmProvider.get(projectScmNamespace, skeletonAppgitRepo, "*/master", "mdop-jenkins-master", null)
...
regressionTestJob.with{
  ...
  scm scmProvider.get(projectFolderName, regressionTestGitRepo, "*/master", "mdop-jenkins-master", null)
  wrappers {
    preBuildCleanup()
    injectPasswords()
    maskPasswords()
